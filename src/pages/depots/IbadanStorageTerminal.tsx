...
const DEPOT_NAME = "Ibadan Storage Terminal";

function IbadanStorageTerminal() {
  ...
  return (
    <>
      <Head><title>Ibadan Storage Terminal | e-Nergy</title></Head>
        ...
        <div className="w-full lg:w-[500px] xl:w-[600px] flex items-center justify-center">
          <div className="w-full bg-white/95 backdrop-blur-sm rounded-lg shadow-2xl overflow-hidden">
            <div className="bg-gradient-to-r from-green-600 to-orange-400 px-4 md:px-6 py-3 md:py-4">
              ...
              <p className="text-center text-white text-xs md:text-sm mt-1 opacity-90">Ibadan Storage Terminal</p>
            </div>
...
export default IbadanStorageTerminal;
